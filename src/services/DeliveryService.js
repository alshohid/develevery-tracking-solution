import { Delivery } from '../modules/delevery/delevery.model.js';
...
export class DeliveryService {
    ...
    async createDelivery(deliveryData) {
        try {
            ...
            const trackingNumber=23236542457
            const qrCode = await this.qrCodeService.generateQRCode(23236542457);
